...
──────────────
Trains TWO models:
  A. Landmark model (PRIMARY)  – fast, MediaPipe features
  B. CNN model (SECONDARY)     – image-based

Run:
  python src/train_model.py --model landmark   (recommended)
  python src/train_model.py --model cnn
  python src/train_model.py --model both
"""
