...
smoothing.py
────────────
Prediction smoothing via two strategies:
  1. MajorityVoteBuffer  – collects N frames, returns most common label
  2. MovingAverageBuffer – averages probability vectors, returns argmax

Also provides:
  SpaceDeleteDetector  – simulates SPACE (timeout) and DELETE (hold) gestures
"""
